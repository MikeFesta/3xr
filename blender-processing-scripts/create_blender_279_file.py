...
model_dir = argv[0]
model_name = argv[1]
project_dir = os.path.join(model_dir, model_name)
working_dir = os.path.join(model_dir, model_name, "blender")
xrs.print_status("Creating 2.79 blend file for " + model_name + " in directory " + working_dir)
# Clear the Scene
xrs.delete_all_objects()

# Import the high res and low res objs
sizes = ["low", "high"]
