...
blender279 --python-exit-code 1 -noaudio "${MODEL_DIR}/${name}/blender/279_${name}.blend" --addons io_scene_gltf2 --python "${BLENDER_3XR_DIR}/gltf_export_hq.py" -- "${name}" "${BLENDER_3XR_DIR}"
