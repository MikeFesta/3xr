...
blender279 --python-exit-code 1 -noaudio --background "${MODEL_DIR}/${name}/blender/279_${name}.blend" --addons io_scene_gltf2 --python "${BLENDER_3XR_DIR}/gltf_export.py" -- "${name}" "${BLENDER_3XR_DIR}"
